...
import com.passmall.domain.EmailDTO;
import com.passmall.domain.MemberVO;
import com.passmall.service.MemberService;
...
public class MemberController {
	...
	public ResponseEntity<String> sendMailAuth(@RequestParam("mbsp_email") String mbsp_email, HttpSession session) {
		...
		EmailDTO dto = new EmailDTO("passmall", "newcomsa@nate.com", mbsp_email, "passmall 인증메일", authCode);
	...
	public ResponseEntity<String> searchPwAction(@RequestParam("mbsp_email") String mbsp_email) {
		...
		*/
		...
		if(!StringUtils.isEmpty(service.searchPwByEmail(mbsp_email))) {
			...
			EmailDTO dto = new EmailDTO("passmall", "newcomsa@nate.com", mbsp_email, "passmall 인증메일", tempPw);
	...
	*/
	...
	public ResponseEntity<String> searchIdAction(@RequestParam("mbsp_email") String mbsp_email) {
		...
		if(!StringUtils.isEmpty(mbsp_id)) {
			...
			EmailDTO dto = new EmailDTO("passmall", "newcomsa@nate.com", mbsp_email, "passmall 인증메일", mbsp_id);

								...
								<tbody>
									...
									<c:forEach items="${orderList }" var="orderVO" varStatus="status">
										<tr role="row"
											...
											<td>
												<input type="checkbox" class="check" value='<c:out value="${orderVO.ord_code }"></c:out>'>
												
											</td>
											<td class="sorting_1">
												<fmt:formatDate value="${orderVO.ord_regdate }" pattern="yyyy-MM-dd mm:hh" />
											</td>
											<td>
											<a class="move" href="<c:out value="${orderVO.ord_code }"></c:out>">
												${orderVO.ord_code }
											</a>
											</td>
											<td>
												<input type="text" value='<c:out value="${orderVO.ord_name }" />'>
											</td>
											<td>주문방법</td>
